...
func _create_material(args: Dictionary) -> Dictionary:
	...
	match type_name:
		...
		_:
			return _error("Invalid material type: {}" .format([type_name]))
...
func _get_material_info(path: String) -> Dictionary:
	...
	if not material:
		return _error("Material not found: {}" .format([path]))
...
func _assign_material_to_node(material_path: String, node_path: String, surface: int) -> Dictionary:
	...
	if not material:
		return _error("Material not found: {}" .format([material_path]))
...
func _create_primitive_mesh(args: Dictionary) -> Dictionary:
	...
	match type:
		...
		_:
			return _error("Invalid primitive type: {}" .format([type]))
