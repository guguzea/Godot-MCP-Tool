...
func _create_light(args: Dictionary) -> Dictionary:
	...
	match light_type:
		...
		_:
			return _error("Unknown light type: {}" .format([light_type]))
...
func _set_light_property(path: String, property: String, value) -> Dictionary:
	...
	if not property in node:
		return _error("Property not found: {}" .format([property]))
...
func _set_bake_mode(path: String, mode: String) -> Dictionary:
	...
	match mode:
		...
		_:
			return _error("Unknown bake mode: {}" .format([mode]))
...
func _set_background_mode(path: String, mode: String) -> Dictionary:
	...
	match mode:
		...
		_:
			return _error("Unknown background mode: {}" .format([mode]))
...
func _create_sky(args: Dictionary) -> Dictionary:
	...
	match sky_type:
		...
		_:
			return _error("Unknown sky type: {}" .format([sky_type]))
...
func _set_sky_process_mode(path: String, mode: String) -> Dictionary:
	...
	match mode:
		...
		_:
			return _error("Unknown process mode: {}" .format([mode]))
