...
func _get_theme_info(path: String) -> Dictionary:
	...
	if not theme:
		return _error("Theme not found: {}" .format([path]))
...
func _set_theme_font(args: Dictionary) -> Dictionary:
	...
	if not font_path.is_empty():
		...
		if not font:
			return _error("Font not found: {}" .format([font_path]))
...
func _set_theme_stylebox(args: Dictionary) -> Dictionary:
	...
	match stylebox_type:
		...
		_:
			return _error("Invalid stylebox type: {}" .format([stylebox_type]))
...
func _clear_theme_item(args: Dictionary) -> Dictionary:
	...
	match data_type:
		...
		_:
			return _error("Invalid data type: {}" .format([data_type]))
...
func _copy_from_default(args: Dictionary) -> Dictionary:
	...
	}, "Copied {} items from default theme" .format([items_copied]))
...
func _assign_theme_to_node(theme_path: String, node_path: String) -> Dictionary:
	...
	if not theme:
		return _error("Theme not found: {}" .format([theme_path]))
	...
	if not node is Control:
		return _error("Node is not a Control: {}" .format([node_path]))
...
func _execute_control(args: Dictionary) -> Dictionary:
	...
	if not node is Control:
		return _error("Node is not a Control: {}" .format([path]))
...
func _set_anchor_preset(control: Control, preset: String) -> Dictionary:
	...
	match preset.to_lower():
		...
		_:
			return _error("Invalid preset: {}" .format([preset]))
...
func _set_focus_mode(control: Control, mode: String) -> Dictionary:
	match mode.to_lower():
		...
		_: return _error("Invalid focus mode: {}" .format([mode]))
...
func _set_mouse_filter(control: Control, filter: String) -> Dictionary:
	match filter.to_lower():
		...
		_: return _error("Invalid mouse filter: {}" .format([filter]))
